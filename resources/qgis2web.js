...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [324571.317275, 6271754.435365, 367721.569067, 6315428.173748], maxZoom: 11, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32719',
...
map.getView().fit([324571.317275, 6271754.435365, 367721.569067, 6315428.173748], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa de Islas de Calor Urbanas- Gran Santiago</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (156 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Temperatura superficial (LST) estimada a partir de un mosaico Landsat del verano 2023-2024 (15 dic 2023 – 25 feb 2024). Temperatura media estimada: 40,1 °C.';
            }
